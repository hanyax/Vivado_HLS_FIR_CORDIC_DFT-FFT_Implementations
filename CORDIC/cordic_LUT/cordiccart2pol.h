...
typedef ap_fixed<8,3> data_t; // Type of the input/output and LUT values. You can change the bitwidth.

#define W			7 // Total size of fixed-point representation. Must be W >= (I+MAN_BITS)
