...
entity mul_test_mul_io_s_axi is
generic (
...
end entity mul_test_mul_io_s_axi;
...
architecture behave of mul_test_mul_io_s_axi is
    ...
    constant ADDR_OUT_R_DATA_0 : INTEGER := 16#10#;
    constant ADDR_OUT_R_CTRL   : INTEGER := 16#14#;
    constant ADDR_IN_R_DATA_0  : INTEGER := 16#18#;
    constant ADDR_IN_R_CTRL    : INTEGER := 16#1c#;
